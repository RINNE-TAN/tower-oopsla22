...
val with_uncomputed :
  Prim_circuit.Gates.t -> Prim_circuit.Gates.t -> Prim_circuit.Gates.t

val with_inverted :
  Prim_circuit.wire list -> Prim_circuit.Gates.t -> Prim_circuit.Gates.t

val cond : Prim_circuit.wire -> Prim_circuit.Gates.t -> Prim_circuit.Gates.t

val swap :
  Prim_circuit.wire list -> Prim_circuit.wire list -> Prim_circuit.Gates.t
